                    ...
                    try
                    {
                        ...
                        XElement xe = new("Facturi",
                            ...
                            select new XElement("Factura",
                                    new XElement("Antet",
                                        new XElement("FurnizorNume"),
                                        new XElement("FurnizorCIF"),
                                        new XElement("FurnizorNrRegCom"),
                                        new XElement("FurnizorCapital"),
                                        new XElement("FurnizorTara"),
                                        new XElement("FurnizorLocalitate"),
                                        new XElement("FurnizorJudet"),
                                        new XElement("FurnizorAdresa"),
                                        new XElement("FurnizorTelefon"),
                                        new XElement("FurnizorMail"),
